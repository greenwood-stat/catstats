...
intplot<-function (formula = NULL, data = NULL, type = "b", x.cont = FALSE,
                   ...
                   xaxt = "s", main = NULL, cld = F, cldshift = 0.1,
                   cldcol = "white", ...) {
#   Modifications by Mark Greenwood, September, 2014 based on interface from
#   compareCatsL by Bryan Hanson, DePauw Univ, Jan 2010 and using the
#   lineplot.CI from the sciplot package
